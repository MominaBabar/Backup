import { GET_ITEMS, DELETE_ITEM, ADD_ITEM, FORGOT_PASSWORD, GET_ALARMS,PORT, MOVE_ROBOT,ITEMS_LOADING,GET_USER, ADD_ALARM, EDIT_ALARM, DELETE_ALARM, GET_HISTORY, EDIT_USER, GET_MEDIA, ADD_MEDIA, IP_ADDRESS, NOTIFY_CLEAN, NOTIFY_BATTERY, GET_CLEAN, GET_BATTERY } from "./types"
...
export const forgotuser = (email) => dispatch =>{
    axios.post(IP_ADDRESS+PORT+'/users/forgot', email).then(res=>
        dispatch({
